...
import {alert} from "../component/alertPage";
...
const Threads = () => {
  ...
  const threaddata= useSelector((store) => store.reducer.threaddata);
  return (
    <>
      <section className="middle border border-[#23272C] w-[850px] relative ">
          ...
          {open && (
           ...
           `}
              >
                ...
                <div className={`border px-0 w-full `}></div>
                <p className="text-gray-500 px-6 pt-4 text-start">Hello jeanne,</p>
                <div
                  id="replyVariable"
        ...
        <div className=" right-side overflow-y-auto scrollbar-w-0 scrollbar-thumb-[black]">
          ...
          {alert && (
            <alert setAlert={setAlert} alert={alert} threadid={threadid} />
          )}
        </div>
      </section>
    </>
